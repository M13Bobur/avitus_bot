...
from app.bot.handlers.admin_branches import router as admin_branches_router
from app.bot.handlers.admin_commands import router as admin_commands_router
from app.bot.handlers.admin_messages import router as admin_messages_router
...
def setup_routers() -> Router:
  ...
  root_router.include_router(admin_messages_router)
  root_router.include_router(admin_branches_router)
